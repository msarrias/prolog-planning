...
(define (domain assembling-domain)
  ...
  ; Person x1 can paint wood y with a tool z if person x1 is holding z, if z can
  ; be used for painting and if person x2 is holding wood y.
  ...
  ; Person x1 can nail wood y with a tool z if x1 is holdind z, if z can be used
  ; for hitting, if wood y is painted and if person x2 is holding wood y.
